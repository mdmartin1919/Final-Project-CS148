...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
    ...
    if (isset($_POST["btnSubmit"])) {
        ...
        $results1 = $thisDatabase->select("SELECT pmkEmployeeNum FROM tblEmployee where pmkEmployeeNum = $number");
        ...
        if (!$errorMsg) {
            ...
            try {
                ...
                $query = 'Delete from tblEmployee where pmkEmployeeNum = ?';
                $data = array($number);
...
//
                ...
                $messageA = '<h2>Your employee with employee number: ' . $number . ' removed!</h2>';
...
// display any error messages before we print out the form
            ...
            <form action="<?php print $phpSelf; ?>"
                ...
                <fieldset class="intro">
                    <legend>Enter the employee number you want to delete</legend>

                    <label for="txtnumber" class="required">Employee Number
                            <input type="text" id="txtnumber" name="txtnumber" 
                                   value=""
                                   tabindex="100" maxlength="40" placeholder="Enter the employee #" 
